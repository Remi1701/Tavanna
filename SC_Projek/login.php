<?php
    ...
    <body>
        ...
        if (isset($_POST['email'])) {
            ...
            $query    = "SELECT * FROM biodata1 WHERE email='$email'
        AND password='" . ($password) . "'";
            ...
            if ($rows == 1) {
                ...
                echo "<div class='form'>
            <h3>Email tidak ditemukan.</h3><br/>
        ...
        ?>
            <form class="form" method="post" name="login">
                ...
                <input type="text" class="login-input" name="email" placeholder="Usernamegi" autofocus="true" />
